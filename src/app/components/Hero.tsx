...
const Hero = () => {
    return (
        <>
            ...
            <div className=' py-[140px] px-[220px] top-[92px]  flex items-center '>
                ...
                <div className='w-[656px] h-[361]'>
                    <div className='w-[656px] h-[238px]'>
                        ...
                        <p className=' font-normal text-lg leading-[30px] tracking [-0.02em]'>Images, videos, PDFs and audio files are supported. Create math expressions
                    ...
                    <div>
                        <button className=' w-[180px] h-[59px] rounded-lg p-5 bg-[#4F9CF9] gap-[10px] text-[18px] font-medium leading-[23px] tracking-[-2%] hover:bg-blue-200 hover:text-[#4F9CF9] hover:border-white hover:border-2'>
            ...
            {/* CUSTOMIZE */}
            <div className='w-[1921px] h-[812px] top-[3268px] ml-[1px] py-[140px] px-[120px]  gap-[10px] flex flex-row-reverse text-black'>
                ...
                {/* left side box  */}
                <div className='w-[1824px] h-[549px] bg-[#C4DEFD] gap-[4px] hover:bg-red-200'></div>
            </div>
